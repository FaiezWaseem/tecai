        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @forelse ($questionsbank as $item)
                                <tr>
                                    <td>
                                        <a href="{{ route('schooladmin.cbts.examquestion.create', ['id' => $item->id, 'exam_id' => $exam_id]) }}" class="btn btn-success">
                    ...
                    {{ $questionsbank->appends(['id' =>  $exam_id])->links() }} <!-- Append the exam ID here -->
                </div>
                        ...
                        <div class="question-container" style="margin-top: 20px; padding: 15px; border: 1px solid #ddd; border-radius: 5px; background-color: #f9f9f9;"> 
                            ...
                            <div class="col-md-12 text-right" style="margin-top: 15px;">
                                <button class="btn btn-danger" 
                                        ...
                                        onclick="setdeleteModalId( {{ $exam_id  }})" 
                                        style="font-size: 1em;"> 
