...
<head>
    ...
    <title>TecInfinity| Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Select "Delete" below if you are ready to Remove the Record.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-danger" id="removeRecord" onclick="deleteRecord(this)" dataid="-1">DELETE</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('dist/img/Loading.gif') }}" alt="Loading.gif" height="80"
                width="80">
        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ now() }} <a href="https://tecdigital.live">.Tec</a>.</strong>
            All rights reserved.
