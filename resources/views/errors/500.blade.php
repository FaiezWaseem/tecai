    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="mb-2 lead">Server Error.</div>
                <div class="mb-2 lead text-danger">Error Message : </div>
                <div class="mb-2 lead text-danger">
                    {{ $message }}</div>
                <a href="{{ url()->previous() }}" class="btn btn-primary">Go Back</a>
                <a href="{{ url()->previous() }}" class="btn btn-danger">Report to Admin</a>
            </div>
        </div>
    </div>
</div>
