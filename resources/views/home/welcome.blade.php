            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Title -->
                        <h1 class="mb-0 display-6"> Tec - Learning Management System
                        ...
                        <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                            <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Learn
                                with experts</li>
                            <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Excel in Life</li>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <!-- Button -->
                            <a href="{{ route('auth.login') }}" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Get
                                Started</a>
                            <!-- Video button -->
                            <div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                                <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tec"
                    ...
                    <div class="col-lg-7 col-xl-6 text-center position-relative">
                        ...
                        <div class="position-relative">
                            <img src="https://teclms.net/homepage/img/demo-screen-2.jpg" alt="Icon">
                        </div>
                    </div>
                    <!-- Right content END -->
                </div>
                    ...
                    @foreach ($boards as $board)
                        <div class="col-sm-6 col-xl-3">
                            <a href="{{ route('home.board', ['id' => $board->id, 'board_name' => $board->board_name]) }}">
                                <div
                                    class=" border d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
