...
function Home({ onclickAddNew }) {
    ...
    const onCreate = async () => {
        ...
        const req = await fetch('../../../utils/create.php', {
            method: 'POST',
            body: form,
        })
        ...
        if (res.success) {
            ...
            link.href = '../../assets/php/create.php?id=' + res.id;
        ...
        // const form = new FormData();
        // form.append('type', 'clue-game')
        // form.append('datablank', JSON.stringify(clues))
    ...
    return <>
        ...
        <div className="d-flex justify-content-center align-items-center">
            <div className="add-answer bg-white mb-5 rounded w-50" onClick={onclickAddNew}>
                <p>+ Add Answer</p>
            </div>
        </div>
