...
var ended = false;
var total = columnLeftNamesInSequence.length;

$(function() {
    'use strict';
   
      var canvasBackgroundColor = 'transparent',
        lineWidth = 5, audio = new Audio('./claps.mp3'),
...
function checkIfGameEnded(){
    ...
    if(total === answeredcounter){
        gradeAssignment(points,total).then(res =>{
            if(res){
                if(res.success){
                    alert('Your Grades Are Added')
                }else{
